...
namespace raytracing
{
    ...
    struct TriangleHit
    {
        ...
        Eigen::Vector3f v;  // view direction
        Eigen::Vector2f uv; // uv coordinates
    ...
    struct Triangle
    {
        ...
        __host__ __device__ bool ray_intersect(const Eigen::Vector3f &ray_o, const Eigen::Vector3f &ray_d, TriangleHit &hit) const
        {
            Eigen::Vector3f v1v0 = b - a;
            Eigen::Vector3f v2v0 = c - a;
            Eigen::Vector3f rov0 = ray_o - a;
            Eigen::Vector3f n = v1v0.cross(v2v0);
            Eigen::Vector3f q = rov0.cross(ray_d);
            float d = 1.0f / ray_d.dot(n);
        ...
        __host__ __device__ bool ray_intersect(const Eigen::Vector3f &ray_o, const Eigen::Vector3f &ray_d) const
        {
            TriangleHit hit_res;
            return ray_intersect(ray_o, ray_d, hit_res);
        }
        ...
        __host__ __device__ float distance_sq(const Eigen::Vector3f &pos) const
        {
            ...
            Eigen::Vector3f p1 = pos - a;
            Eigen::Vector3f v32 = c - b;
            Eigen::Vector3f p2 = pos - b;
            Eigen::Vector3f v13 = a - c;
            Eigen::Vector3f p3 = pos - c;
